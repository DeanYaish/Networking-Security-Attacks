...
unsigned int telnet_outgoing(void* priv, struct sk_buff* skb, const struct nf_hook_state* state)
{
	...
	if (iph->protocol == IPPROTO_TCP && tcph->dest == htons(23) && iph->saddr == in_aton("10.0.2.17") && iph->daddr == in_aton("10.0.2.18")) {
...
unsigned int ssh_outgoing(void* priv, struct sk_buff* skb, const struct nf_hook_state* state)
{
	...
	if (iph->protocol == IPPROTO_TCP && tcph->dest == htons(22) && iph->saddr == in_aton("10.0.2.17") && iph->daddr == in_aton("10.0.2.18")) {
...
unsigned int telnet_incoming(void* priv, struct sk_buff* skb, const struct nf_hook_state* state)
{
	...
	if (iph->protocol == IPPROTO_TCP && tcph->dest == htons(23) && iph->saddr == in_aton("10.0.2.18") && iph->daddr == in_aton("10.0.2.17")) {
...
unsigned int ssh_incoming(void* priv, struct sk_buff* skb, const struct nf_hook_state* state)
{
	...
	if (iph->protocol == IPPROTO_TCP && tcph->dest == htons(22) && iph->saddr == in_aton("10.0.2.18") && iph->daddr == in_aton("10.0.2.17")) {
...
unsigned int web_block(void* priv, struct sk_buff* skb, const struct nf_hook_state* state)
{
	...
	if (iph->protocol == IPPROTO_TCP && iph->saddr == in_aton("10.0.2.17") && iph->daddr == in_aton("35.241.7.97") && (tcph->dest == htons(80) || tcph->dest == htons(443))) {
